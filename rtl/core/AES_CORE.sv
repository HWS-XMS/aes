import AES_PKG::*;
// AES_CORE - keyed AES core, one FSM (IDLE/KEYEXP/ENC/DEC; ready, key_loaded, no
// error flag; strobes sampled in IDLE, priority update_key > encrypt > decrypt).
// Runtime keysize latched at update_key.
module AES_CORE (
    input  logic         clk,
    input  logic         rst,
