...
// INVSUBBYTES_MASKED - masked InvSubBytes: 16 INVSBOX_MASKED, one per state byte (mirror
// of SUBBYTES_MASKED).  Latency = S-box (8).  rnd = 16*sbox_rand_words(N).
module INVSUBBYTES_MASKED #(
    parameter  int N    = 2,
