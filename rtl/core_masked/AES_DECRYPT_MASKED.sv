...
// AES_DECRYPT_MASKED - fully-unrolled DOM-masked decrypt datapath, runtime keysize.
...
module AES_DECRYPT_MASKED #(
    ...
    INVLASTROUND_MASKED #(N) inv_last (
        .clk       (clk                         ),
        .rst       (rst                         ),
