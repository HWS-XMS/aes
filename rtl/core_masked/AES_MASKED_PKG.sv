// AES_MASKED_PKG - shared GF(2^8) math for the DOM/HPC1-masked AES: Fermat inversion in
...
package AES_MASKED_PKG;
    ...
    // Fresh words a REFRESH_MASKED (SNI refresh) of n shares consumes (fullverif MSKref):
    // n=2 -> 1, n=3 -> 2, n>=4 -> n.
