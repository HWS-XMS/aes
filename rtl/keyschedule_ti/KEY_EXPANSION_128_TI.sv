import AES_PKG::*;
import AES_TI_PKG::*;
// KEY_EXPANSION_128_TI - DOM-masked AES-128 key schedule, N shares.  RotWord and
// the column XORs are share-wise linear; Rcon is a constant into one share; SubWord
// is the masked SBOX_TI.  With a stable key the round keys settle after the deepest
