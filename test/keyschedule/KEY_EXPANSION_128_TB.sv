import AES_PKG::*;
// KEY_EXPANSION_128_TB - pipelined AES-128 key schedule vs the NIST reference
// (keyexp128_*.mem, FIPS-197 App. A).  Drives the key_valid/key_ready handshake and
// checks the settled round_keys.
