import AES_PKG::*;
// AES_CORE_TB - end-to-end test of the keyed core across all three runtime sizes.
// For every OpenSSL vector: update_key -> encrypt (check) -> decrypt (check),
// re-keying every vector.  Also checks key_loaded and that a strobe asserted while
// busy is ignored.  References are OpenSSL/NIST (test/ref/aes*_{pt,key,ct}.mem).
module AES_CORE_TB;
