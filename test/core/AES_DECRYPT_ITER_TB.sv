import AES_PKG::*;
// AES_DECRYPT_ITER_TB - drives the iterative decrypt datapath; checks every recovered
// plaintext vs the OpenSSL vectors (round keys from the verified KEY_EXPANSION), all sizes.
module AES_DECRYPT_ITER_TB;
    ...
    initial begin
        ...
        `TB_SUMMARY("AES_DECRYPT_ITER_TB");
    end
endmodule
