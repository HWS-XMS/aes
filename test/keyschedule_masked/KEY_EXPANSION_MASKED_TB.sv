...
// KEY_EXPANSION_MASKED_TB - keysize-agnostic masked key-schedule distributor, N = 2.
...
module KEY_EXPANSION_MASKED_TB;
    ...
    initial begin
        ...
        `TB_SUMMARY("KEY_EXPANSION_MASKED_TB");
    end
endmodule
