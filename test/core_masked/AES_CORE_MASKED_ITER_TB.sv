...
// AES_CORE_MASKED_ITER_TB - end-to-end DOM-masked iterative keyed core, N = 2, all sizes.
// Drives the FSM (update_key/encrypt/decrypt, wait ready) with shared shares and fresh
// DOM randomness every cycle; recombined data_out vs OpenSSL.  Rekey is reset-free.
module AES_CORE_MASKED_ITER_TB;
    ...
    initial begin
        ...
        `TB_SUMMARY("AES_CORE_MASKED_ITER_TB");
    end
endmodule
