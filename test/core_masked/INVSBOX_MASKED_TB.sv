...
// INVSBOX_MASKED_TB - DOM/HPC1-masked inverse S-box vs the NIST table, N = 2, 3, 4.
// recombine(masked) == invsbox.mem after the S-box latency (8), fresh randomness.
module INVSBOX_MASKED_TB;
