...
// REFRESH_MASKED_TB - a refresh must PRESERVE the shared value: recombine(c) ==
// recombine(a) for any input sharing and any fresh randomness, N = 2, 3, 4.
// Latency = 1.  (Security is exercised by the GF_INV_MASKED probing proof.)
module REFRESH_MASKED_TB;
