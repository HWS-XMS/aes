...
// AES_ENCRYPT_MASKED_ITER_TB - iterative DOM-masked encrypt datapath, N = 2, all sizes.
// Round-key shares from KEY_EXPANSION_MASKED (key_rnd = 0 -> stable) muxed by size;
// datapath runs rnd = 0.  Recombined ciphertext vs OpenSSL.
module AES_ENCRYPT_MASKED_ITER_TB;
    ...
    initial begin
        ...
        `CHK("done", 1);
        `TB_SUMMARY("AES_ENCRYPT_MASKED_ITER_TB");
    end
endmodule
