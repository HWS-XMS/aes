...
// GF_INV_MASKED_TB - HPC1-masked GF(2^8) inverse x^254, N = 2, 3, 4.  gf_inv_ref is
...
module GF_INV_MASKED_TB;
    ...
    // x^254 via the Fermat addition chain (field ops from AES_MASKED_PKG)
