...
// AES_DECRYPT_MASKED_TB - tapped DOM-masked decrypt datapath, N = 2, all three sizes.
...
module AES_DECRYPT_MASKED_TB;
    ...
    initial begin
        ...
        `CHK("done", 1);
        `TB_SUMMARY("AES_DECRYPT_MASKED_TB");
    end
endmodule
