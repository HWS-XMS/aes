import AES_PKG::*;
import AES_TI_PKG::*;
// INVSUBBYTES_TI_TB - masked InvSubBytes vs unmasked INVSUBBYTES, N = 2, 3.
// recombine(masked) == unmasked for random states, fresh randomness.  Latency = 8.
module INVSUBBYTES_TI_TB;
