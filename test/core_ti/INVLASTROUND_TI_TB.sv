import AES_PKG::*;
import AES_TI_PKG::*;
// INVLASTROUND_TI_TB - masked final inverse round vs unmasked INVLASTROUND
// (registered), N = 2, 3.  recombine(masked) == unmasked, fresh randomness.  Lat = 8.
module INVLASTROUND_TI_TB;
